...
@Component({
  ...
  template: `
    <h1 i18n class="jumbotron" style="font-size: 200%; text-align: center">Contact Us</h1>
    <div class="my-container">
    <div class="row">
      <div class="col">
        <p i18n style="font-size: 150%">If you have any questions, <br>
        ...
        <p i18n style="font-size: 150%">Our Services are open from Monday to friday from 8:00AM to 5:30PM Eastern time.</p><br><br>
        <label i18n for="email" style="font-size: 150%">Email:</label>
        <a i18n href="mailto:noreply.wondacabinetinc@gmail.com" style="font-size: 150%"> wondacabinet@gmail.com</a>
        <br/><br/>
        <label i18n for="email" style="font-size: 150%">Phone:</label>
        <a i18n href="tel:416-335-9788" style="font-size: 150%">(416) 335-9788</a><br><br>

        <h2 i18n style="font-size: 150%">You can also visit our offices</h2>
